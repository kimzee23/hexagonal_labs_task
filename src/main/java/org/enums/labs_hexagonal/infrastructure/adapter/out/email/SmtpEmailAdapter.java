package org.enums.labs_hexagonal.infrastructure.adapter.out.email;
...
public class SmtpEmailAdapter implements EmailPort {
    ...
    public void sendVerificationEmail(String email, String token) {
        String verificationLink = "http://localhost:8081/v1/auth/verify-email?token=" + token;

        log.info("=== SMTP EMAIL (SIMULATED) ===");
